      ...
      <div class="top">
        <div>
          <ul class="list-unstyled list-inline ulList">
            ...
            <li class="mobilephone list-inline-item">
              <a href>分享i前端给小伙伴</a>
            </li>
            <li class="email list-inline-item">反馈邮箱：iweb@126.com</li>
            <li class="telephone list-inline-item">客服热线：4008-200-200</li>
          </ul>
        </div>
      </div>
    </b-container>
      ...
      <div class="h_right">
        ...
        <div class="h_cart">
          ...
          <div class="cart_dropdown">
            <h3 v-show="$global.isLogin == false">
              请
              <router-link :to="{name:'login'}" style="color:blue">登录</router-link>后查看您的购物车
            </h3>
